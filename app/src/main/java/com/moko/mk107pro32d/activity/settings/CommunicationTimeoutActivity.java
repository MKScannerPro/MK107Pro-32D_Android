package com.moko.mk107pro32d.activity.settings;
...
import com.moko.mk107pro32d.databinding.ActivityCommunicationTimeout107pro32dBinding;
...
public class CommunicationTimeoutActivity extends BaseActivity<ActivityCommunicationTimeout107pro32dBinding> {
    ...
    @Override
    protected ActivityCommunicationTimeout107pro32dBinding getViewBinding() {
        return ActivityCommunicationTimeout107pro32dBinding.inflate(getLayoutInflater());
    }
    ...
    private void setCommunicationTimeout(int timeout) {
        ...
        if (mMokoDevice.deviceType == 0x61) msgId = MQTTConstants.CONFIG_MSG_ID_BLE_CONNECT_TIMEOUT;
    ...
    private void getCommunicationTimeout() {
        ...
        if (mMokoDevice.deviceType == 0x61) msgId = MQTTConstants.READ_MSG_ID_BLE_CONNECT_TIMEOUT;
