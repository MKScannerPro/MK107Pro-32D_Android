...
import com.moko.mk107pro32d.databinding.ActivityBxpTRemoteReminder107pro32dBinding;
...
public class BXPTRemoteReminderActivity extends BaseActivity<ActivityBxpTRemoteReminder107pro32dBinding> {
    ...
    protected void onCreate() {
        ...
        mBind.clBuzzerNotify.setVisibility(mBeaconType == 6 && mMokoDevice.deviceType != 0x60 ? View.VISIBLE : View.GONE);
    }

    @Override
    protected ActivityBxpTRemoteReminder107pro32dBinding getViewBinding() {
        return ActivityBxpTRemoteReminder107pro32dBinding.inflate(getLayoutInflater());
    }
