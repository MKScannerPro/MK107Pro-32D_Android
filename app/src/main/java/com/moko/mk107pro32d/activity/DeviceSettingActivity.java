...
import com.moko.mk107pro32d.activity.add.AdvSettingsActivity;
import com.moko.mk107pro32d.activity.add.AdvertiseIBeaconActivity;
import com.moko.mk107pro32d.activity.modify.ModifySettingsActivity;
import com.moko.mk107pro32d.activity.settings.ButtonResetActivity;
import com.moko.mk107pro32d.activity.settings.CommunicationTimeoutActivity;
import com.moko.mk107pro32d.activity.settings.DeviceInfoActivity;
import com.moko.mk107pro32d.activity.settings.IndicatorSettingActivity;
import com.moko.mk107pro32d.activity.settings.NetworkReportIntervalActivity;
import com.moko.mk107pro32d.activity.settings.OTAActivity;
import com.moko.mk107pro32d.activity.settings.ReconnectTimeoutActivity;
import com.moko.mk107pro32d.activity.settings.SystemTimeActivity;
...
public class DeviceSettingActivity extends BaseActivity<ActivityDeviceSetting107pro32dBinding> {
    ...
    protected void onCreate() {
        ...
        mBind.tvReconnectTimeout.setVisibility(mMokoDevice.deviceType == 0x60 ? View.VISIBLE : View.GONE);
        mBind.tvAdvIbeacon.setVisibility(mMokoDevice.deviceType == 0x60 ? View.VISIBLE : View.GONE);
        mBind.tvAdvSettings.setVisibility(mMokoDevice.deviceType != 0x60 ? View.VISIBLE : View.GONE);
