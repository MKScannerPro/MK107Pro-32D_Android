...
import com.moko.mk107pro32d.databinding.ActivityFilterNano107pro32dBinding;
...
public class FilterNanoActivity extends BaseActivity<ActivityFilterNano107pro32dBinding> {
    ...
    @Override
    protected ActivityFilterNano107pro32dBinding getViewBinding() {
        return ActivityFilterNano107pro32dBinding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_NANO) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : codeList) {
                    ...
                    View v = LayoutInflater.from(FilterNanoActivity.this).inflate(R.layout.item_nano_filter_107pro32d, mBind.llId, false);
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.item_nano_filter_107pro32d, mBind.llId, false);
        TextView title = v.findViewById(R.id.tvTitle);
