...
public class WifiSettingsActivity extends BaseActivity<ActivityWifiSettings107pro32dBinding> {
    ...
    protected void onCreate() {
        ...
        int beaconType = getIntent().getIntExtra(AppConstants.EXTRA_KEY_BEACON_TYPE, 0x60);
        boolean isFirstConfig = getIntent().getBooleanExtra(AppConstants.EXTRA_KEY_FIRST_CONFIG, false);
        mBind.ivSearch.setVisibility(beaconType == 0x61 && isFirstConfig ? View.VISIBLE : View.GONE);
