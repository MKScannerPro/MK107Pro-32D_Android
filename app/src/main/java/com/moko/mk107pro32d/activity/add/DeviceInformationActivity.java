...
public class DeviceInformationActivity extends BaseActivity<ActivityDeviceInfo107pro32dBinding> {
    ...
    protected void onCreate() {
        ...
        mBind.layoutBTFirmware.setVisibility(selectedDeviceType == 0x61 ? View.VISIBLE : View.GONE);
        mBind.lineBTFirmware.setVisibility(selectedDeviceType == 0x61 ? View.VISIBLE : View.GONE);
