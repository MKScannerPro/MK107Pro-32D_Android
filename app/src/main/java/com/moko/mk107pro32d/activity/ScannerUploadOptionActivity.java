...
import com.moko.mk107pro32d.activity.upload.UploadDataIntervalActivity;
import com.moko.mk107pro32d.activity.upload.UploadDataOptionActivity;
import com.moko.mk107pro32d.activity.upload.UploadDataParsingActivity;
...
public class ScannerUploadOptionActivity extends BaseActivity<ActivityScannerUploadOption107pro32dBinding> implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate() {
        ...
        mBind.clDuplicateDataFilter.setVisibility(mMokoDevice.deviceType != 0x60 ? View.VISIBLE : View.GONE);
        mBind.clScanMode.setVisibility(mMokoDevice.deviceType != 0x60 ? View.VISIBLE : View.GONE);
        mBind.tvDataParsingSettings.setVisibility(mMokoDevice.deviceType != 0x60 ? View.VISIBLE : View.GONE);
        mBind.tvUploadDataInterval.setVisibility(mMokoDevice.deviceType != 0x60 ? View.VISIBLE : View.GONE);
        mBind.rlDuplicateDataFilter.setVisibility(mMokoDevice.deviceType != 0x60 ? View.GONE : View.VISIBLE);
        ...
        if (mMokoDevice.deviceType != 0x60)
            mRelationshipValues.add("MAC/ADV name/Raw data");
